...
function renderInstallerPage($steps, $current_step, $errors, $success) {
    ...
    <body>
                ...
                <div class="col-lg-10 col-xl-8">
                    <div class="card installer-card fade-in">
                        <div class="card-header bg-primary text-white text-center py-3">
                            <h2 class="mb-1"><i class="fas fa-cog me-2"></i>PhPstrap Installer</h2>
                            <small class="opacity-75">Modular PHP Members Database System</small>
                        </div>
                        ...
                        <div class="card-footer text-center text-muted py-3">
                            <small>
                                ...
                                PhPstrap v1.0.0 &copy; <?php echo date('Y'); ?> | 
        ...
        <script>
            ...
            function toggleModule(card, moduleName) {
...
function renderStepIndicator($steps, $current_step) {
    ...
    <div class="step-indicator text-center">
        ...
        <div class="mt-4">
            <h4 class="mb-1"><?php echo $steps[$current_step]; ?></h4>
            <div class="progress" style="height: 8px;">
                <div class="progress-bar bg-primary" 
                     style="width: <?php echo (($current_step - 1) / (count($steps) - 1)) * 100; ?>%"></div>
            </div>
            <small class="text-muted">Step <?php echo $current_step; ?> of <?php echo count($steps); ?></small>
        </div>
    </div>
    <?php
}
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="card bg-light">
                    ...
                    <div class="card-body">
                        <small>
                            <strong>PHP Version:</strong> <?php echo $phpInfo['version']; ?><br>
                            <strong>Server API:</strong> <?php echo $phpInfo['sapi']; ?><br>
                            <strong>Memory Limit:</strong> <?php echo $phpInfo['memory_limit']; ?><br>
                            <strong>Max Execution:</strong> <?php echo $phpInfo['max_execution_time']; ?>s<br>
                            <strong>Upload Limit:</strong> <?php echo $phpInfo['upload_max_filesize']; ?><br>
                            <strong>Post Limit:</strong> <?php echo $phpInfo['post_max_size']; ?><br>
                            <strong>Timezone:</strong> <?php echo $phpInfo['date_timezone']; ?>
                        </small>
                    </div>
                </div>
            </div>
        ...
        <form method="post" id="moduleForm">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="module-card card h-100" onclick="toggleModule(this, 'hcaptcha')">
                        <div class="card-body text-center p-4">
                            <div class="module-icon bg-primary text-white">
                                <i class="fas fa-shield-alt"></i>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="modules[]" value="hcaptcha" id="module_hcaptcha">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="module-card card h-100" onclick="toggleModule(this, 'smtp')">
                        <div class="card-body text-center p-4">
                            <div class="module-icon bg-success text-white">
                                <i class="fas fa-envelope"></i>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="modules[]" value="smtp" id="module_smtp">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="module-card card h-100" onclick="toggleModule(this, 'analytics')">
                        <div class="card-body text-center p-4">
                            <div class="module-icon bg-warning text-white">
                                <i class="fas fa-chart-line"></i>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="modules[]" value="analytics" id="module_analytics">
