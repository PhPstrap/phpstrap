...
class Settings {
    ...
    private static function castValue($value, $type) {
        switch ($type) {
            ...
            case 'array':   return explode(',', (string)$value);
            default:        return $value;
        }
    }

    public static function getAll() {
        if (!self::$loaded) self::loadSettings();
        return self::$cache;
    }
...
function getSetting($key, $default = null) { return Settings::get($key, $default); }
function setSetting($key, $value, $type = 'string') { return Settings::set($key, $value, $type); }
?>